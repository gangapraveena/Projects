...
<title>product list Angular</title>
<link rel="stylesheet"
...
<body>
<div ng-app="myapp">
<div ng-controller="productController" ng-init="getProductList()">

<H1 > List of Productes</H1>
...
<tbody>
<tr ng-repeat="b in product | filter:searchCondition">
...
<c:url value="resources/images/{{b.isbn}}.png" var="src"/>
		...
		<td><a href="getProductByIsbn/{{b.isbn}}"><span class="glyphicon glyphicon-info-sign"></span></a>
