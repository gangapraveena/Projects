...
<body>
<c:url value="addWatch" var="b"></c:url>
	<form:form method="post" action="${b}" commandName="watchFormObj" enctype="multipart/form-data">
		<table>
			<tr>
			...
			<tr><td><form:input type="file" path="watchImage"/></td></tr>
			<tr>
				<td colspan="2s"><input type="submit" value="AddWatch"></td>
			</tr>
